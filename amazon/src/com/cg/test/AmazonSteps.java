...
public class AmazonSteps {
	...
	public void five_products_are_selected() throws Throwable {
	    ...
	    AmazonResult.selectOnePlus(driver).click();
	    ...
	    AmazonResult.addToCart(driver).click();
	    driver.navigate().to("https://www.amazon.in/");
	    HomePage.searchBox(driver).sendKeys("iphone x");
	    HomePage.searchBox(driver).sendKeys(Keys.ENTER);
	    AmazonResult.selectIPhone(driver).click();
	    ...
	    HomePage.searchBox(driver).sendKeys(Keys.ENTER);
	    AmazonResult.selectHp(driver).click();
	    ...
	    HomePage.searchBox(driver).sendKeys(Keys.ENTER);
	    AmazonResult.selectps4(driver).click();
